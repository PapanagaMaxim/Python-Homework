...
if "Python" in text and "Java" in text:
    print("Textul conține ambele cuvinte: 'Python' și 'Java'.")
elif "Python" in text or "Java" in text:
    print("Textul conține doar unul dintre cuvinte: 'Python' sau 'Java'.")
else:
    print("Textul nu conține nici 'Python' nici 'Java'.")
# CODUL TĂU VINE MAI SUS:
...
if number == 1:
    ...
    print("Numărul introdus nu este în interval.")
# CODUL TĂU VINE MAI SUS:
